	...
	<header id="home">
		...
		?>
			<div style="text-align: center;color: black;">
				...
				<br><br>
					<br><br>
					<h4 >Modify Current Events</h4><br>
					<?php
		...
		foreach($_FILES["files"]["tmp_name"] as $key=>$tmp_name)
		{
			...
			if($uploadThisFile)
			{
				...
				$sq="insert into c_event_gallery(id,FilePath,FileName) values ('{$_POST["id"]}','Upload','".$newFileName."')";
		...
		if($count != 0){
			...
			<button style="text-align: center;" type="submit" class="primary-button" name="submit">Insert</button> <br>
				...
				<div class="lbox">
					...
					<h5 style="margin-top:30px;" class="primary-button"> <a style="text-align: center;"" href="preview_c_events.php" class="primary-button" style="margin-top:30px;">Preview</h5></a>
					<br>
					<br>
							<div class="content1">
