...
$s="SELECT * FROM programmes WHERE id={$_GET["id"]}";
		$q = mysqli_query($db,$s);
		 while(
		...
		$sql="update programmes set visitors='$visits' where id={$_GET["id"]}";
		...
		<nav id="main-navbar">
			<div class="container">
				...
				<ul class="navbar-menu nav navbar-nav navbar-right">
					...
					<li class="has-dropdown" style="background-color: #EFEFEF;"><a href="programmes.php">Programmes</a>
					<ul class="dropdown">
						...
						<div class='col-md-13'>
							<div class='article'>
								...
								<div class='article-content'>
									<h3 class='article-title'>{$r["programme_name"]}</a></h3>
									<ul class='event-meta'>
