	...
	<header id="home">
		...
		?>
			<div id="section" style="text-align: center;">
				...
				<br><a style="text-align: center;" href="preview_slides.php" class="primary-button" style="margin-top:30px;">Preview</a>
					<br>
					<br>
					</div>
