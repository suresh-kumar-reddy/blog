...
<div id='about' class='section' style='text-align: justify;
	...
	<br>
	<a class="btn btn-success" href="cms_about.php">Home </a>
	...
	<table class="table table-striped table-bordered">
		...
		if(mysqli_num_rows($result)>0)
		{
			while($row=mysqli_fetch_assoc($result))
			{
				...
				echo '<td><a href="show.php?delid='.$row['id'].'" type="button" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a></td>';
