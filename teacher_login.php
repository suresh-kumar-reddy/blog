		...
		<div class="login" style="margin-left:10px;">
			...
			<div class="log">
				...
				<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
					...
					<input type="password" name="pass" required class="input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Your Password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"><br>
