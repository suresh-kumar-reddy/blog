			...
			<div id="section" style="margin-left:10px;">
				...
				<div class="content">
					...
					<?php
						...
						{	
							$sql="update events set event_name='{$_POST["event_name"]}',event_date='{$_POST["event_date"]}',description='{$_POST["description"]}',description2='{$_POST["description2"]}',event_time='{$_POST["event_time"]}',event_location='{$_POST["event_location"]}' WHERE id={$_GET["id"]}";
							...
							{
								$sql="update events set slide='{$target_file}' WHERE id={$_GET["id"]}";
																		$db->query($sql);
										echo "<div class='success'>Updated Successfully</div>";
